...
export const restaurantMenuItems: RestaurantMenuItem[] = [
  ...
  },
  {
    category: "Hot Appetizer",
    name: "Hangover Fries",
    description: "House special loaded fries with SYKO spices.",
    price: "$16",
  },
  {
    category: "Salads",
  ...
  },
  {
    category: "Salads",
    name: "Protein Salad",
    description: "Mixed greens with your choice of protein and house dressing.",
    price: "$13",
  },
  {
    category: "Sandwiches",
  ...
  {
    category: "Sandwiches",
    name: "Chicken Shawarma Hotteok",
    description:
      "Chicken shawarma stuffed in a scallion hotteok with pickles, garlic paste, and french fries.",
    price: "$16",
    menuChoice: "SYKO FUSION",
  },
  {
    category: "Sandwiches",
    name: "Meat Shawarma Hotteok",
    description:
      "Meat shawarma stuffed in a scallion hotteok with pickles, parsley, tomatoes, onions, and tahini.",
    price: "$16",
    menuChoice: "SYKO FUSION",
  },
  {
    category: "Sandwiches",
    name: "Kimchi Falafel Sandwich",
    description: "House falafels and cucumber kimchi wrapped in pita with assorted vegetables.",
    price: "$16",
    menuChoice: "SYKO FUSION",
  },
  {
  ...
  },
  {
    category: "Sandwiches",
    name: "Spam Sandwich",
    description: "Toasted spam sandwich with SYKO fixings.",
    price: "$15",
    menuChoice: "Korean Menu",
  },
  {
  ...
  },
  {
    category: "Main Course",
    name: "Kalbi",
    description: "Marinated kalbi served with rice and choice of 2 banchan.",
    price: "$29",
    menuChoice: "Korean Menu",
    note: "Each entree includes 2 banchan and plain rice. Kimchi fried rice +$4.",
  },
  ...
  {
    category: "Main Course",
    name: "Tofu Kimchi Hummus",
    description: "Stir-fried tofu and kimchi on a bed of hummus.",
    price: "$18",
    menuChoice: "SYKO FUSION",
  },
  {
    category: "Main Course",
    name: "Bulgogi Kimchi Hummus",
    description: "House beef bulgogi and kimchi on a bed of hummus.",
    price: "$18",
    menuChoice: "SYKO FUSION",
  },
  {
    category: "Main Course",
    name: "Chicken Bulgogi Mubummura",
    description: "House chicken bulgogi on a bed of muhummura.",
    price: "$18",
    menuChoice: "SYKO FUSION",
  },
  {
