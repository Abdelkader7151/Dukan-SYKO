...
export const metadata: Metadata = {
  title: "Visit SYKO | Restaurant and Dukan Locations in Brooklyn",
  description:
    ...
    <div className="pt-16">
      ...
      <section className="relative h-56 flex items-end overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image src="/illustrations/SyKo-12.png" alt="Brooklyn Bridge"
      ...
      <section className="shell section-pad">
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <article className="card card-red p-8 relative overflow-hidden">
            <div className="absolute right-0 bottom-0 w-36 h-36 illus opacity-15">
              <Image src="/illustrations/SyKo-09.png" alt="" fill className="object-contain" />
            </div>
            ...
            <a href="tel:+19294240423" className="btn-primary mt-6 inline-flex">Call Restaurant</a>
          </article>

          {/* Dukan */}
          <article className="card p-8 relative overflow-hidden">
            <div className="absolute right-0 bottom-0 w-28 h-28 illus opacity-20">
              <Image src="/illustrations/SyKo-05.png" alt="" fill className="object-contain" />
            </div>
        ...
        <div className="mt-10 relative h-52 rounded-2xl overflow-hidden border border-[rgba(240,217,168,0.1)]">
          <Image src="/illustrations/SyKo-12.png" alt="Brooklyn Bridge — we are in Brooklyn"
            fill className="object-cover object-center opacity-35 illus" sizes="100vw" />
          <Image src="/illustrations/SyKo-02.png" alt="New York skyline"
          ...
          <div className="absolute left-8 top-1/2 -translate-y-1/2">
            ...
            <p className="text-[#f0d9a8] text-sm mt-1">Windsor Terrace · Park Slope</p>
          </div>
        </div>
      </section>
    </div>
